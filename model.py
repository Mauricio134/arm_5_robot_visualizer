...
func.create_window(whole_map, exact_point, dimensions, separations, size_whole_arm_array, min_point, max_point, base_arm_1, base_arm_2, whole_map[exact_point[0]][exact_point[1]], size_between_motors, angles_per_step, total_duration_ms)
